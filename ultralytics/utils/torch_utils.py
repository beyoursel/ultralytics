...
TORCH_1_9 = check_version(str(torch.__version__), "1.9.0")
TORCH_1_13 = check_version(str(torch.__version__), "1.13.0")
TORCH_2_0 = check_version(str(torch.__version__), "2.0.0")
TORCH_2_4 = check_version(str(torch.__version__), "2.4.0")
